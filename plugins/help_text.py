...
async def help_user(bot, update):
    ...
    await bot.send_message(
        ...
        [
          [
          InlineKeyboardButton('📍 JOIN CHANNEL 📍', url='https://t.me/MoviezAddaKan'),
          ]
        ]
       ),
       reply_to_message_id=update.message_id
...
async def start(bot, update):
    ...
    await bot.send_message(
        ...
        [
          [
          InlineKeyboardButton('📍 CHANNEL', url='https://t.me/MoviezAddaKan'),
      ],
      [
          InlineKeyboardButton('👨‍💻 DEVELOPER', url='https://t.me/captblacknight'),
          InlineKeyboardButton('🌝 SOURCE', url='https://t.me/MoviezAddaKan'),
          ]
        ]
      ),
      reply_to_message_id=update.message_id
